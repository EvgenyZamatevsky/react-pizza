...
export const Cart: FC = (): ReturnComponentType => {
	...
	const renderCartItems = cartItems.map(({ count, id, imageUrl, price, size, title, type }) => {
		return <CartItem key={id} id={id} count={count} imageUrl={imageUrl} price={price} size={size} title={title} type={type} />
	})
			...
			<div className='cart'>
				<div className='cart__top'>
					<h2 className='content__title'>
						...
						Корзина</h2>
					<span className='cart__clear' onClick={onClearCartItemsClick}>
